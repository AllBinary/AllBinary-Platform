...
{
   public static BasicProjectileWeaponPart createBasicProjectileWeaponPart(final Animation animationInterface, final WeaponLayerCircularPool weaponLayerCircularStaticPool) {
