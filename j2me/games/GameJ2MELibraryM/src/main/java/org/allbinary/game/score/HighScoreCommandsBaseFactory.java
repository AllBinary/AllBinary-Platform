...
public class HighScoreCommandsBaseFactory {
    ...
    protected HighScoreCommandsBaseFactory(Command[] HIGH_SCORE_COMMANDS)
    {
        if(J2MEUtil.isJ2ME())
        {
            //this.logUtil.put(commonStrings.START).append("J2ME", this, commonStrings.CONSTRUCTOR);
        ...
        {
            //this.logUtil.put(commonStrings.START).append("not J2ME", this, commonStrings.CONSTRUCTOR);
