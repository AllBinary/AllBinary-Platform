...
public class DemoGameMidlet extends GameMidlet
{
    ...
    {
        this.logUtil.put(commonStrings.START, this, "setDemo");
    ...
    public synchronized void createGame() throws Exception
    {
        ...
        this.logUtil.put(commonStrings.START, this, CREATE_GAME);
        ...
        this.logUtil.put(commonStrings.END, this, CREATE_GAME);
    }
