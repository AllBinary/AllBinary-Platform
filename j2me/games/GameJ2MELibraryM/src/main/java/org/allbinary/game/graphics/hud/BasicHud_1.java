...
public class BasicHud_1 implements UpdateMyFontInterface //DisplayChangeEventListener
{
    ...
    public BasicHud_1(final int location, final int direction, final int bufferZone, final BasicColor basicColor) {
