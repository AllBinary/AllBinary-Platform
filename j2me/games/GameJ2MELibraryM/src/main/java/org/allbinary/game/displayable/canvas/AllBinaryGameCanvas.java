        ...
        DisplayChangeEventListener
{
    ...
    public void processSleep() throws Exception
    {
        ...
        {
            // this.logUtil.putF("Menu Processing While Sleeping", this, PROCESS_SLEEP);
    ...
    protected void initMenu()
    {
        try
        {
            //this.logUtil.putF("initMenu", this, this.commonStrings.PROCESS);
    ...
    protected void initMenu2() throws Exception
    {
        ...
        if (features.isFeature(this.touchFeatureFactory.TOUCH_ENABLED)) {
            //this.logUtil.putF("initMenu - touch", this, this.commonStrings.PROCESS);
            ...
            //this.logUtil.putF("initMenu - no touch", this, this.commonStrings.PROCESS);
        }
        ...
        if (scrollSelectionForm != ScrollSelectionFormNoneFactory.getInstance()) {
            //this.logUtil.putF("initMenu - scroll", this, this.commonStrings.PROCESS);
            this.setFormPaintable(new FormPaintable(scrollSelectionForm));
        } else {
            //this.logUtil.putF("initMenu - no scroll", this, this.commonStrings.PROCESS);
        }
            ...
            boolean buffered) throws Exception
    {
        ...
        //this.logUtil.putF(
        //"isDoubleBuffered: ").append(this.isBuffered()).append("isDoubleBuffered: ").append(this.isDoubleBuffered(), //this, this.commonStrings.CONSTRUCTOR);
    ...
    protected synchronized void initConfigurable(final AbeClientInformationInterface abeClientInformation) throws Exception
    {
        ...
        if (changedGameFeatureListener.isChangedFeature(gameFeatureFactory.SOUND))
        {
            ...
            this.logUtil.putF(new StringMaker().append("Sound Changing To: ").appendboolean(
        ...
        if (changedGameFeatureListener.isChangedFeature(sensorFeatureFactory.ORIENTATION_SENSORS)
                || changedGameFeatureListener.isChangedFeature(sensorFeatureFactory.NO_ORIENTATION)
                || changedGameFeatureListener.isChangedFeature(sensorFeatureFactory.SIMULATED_ORIENTATION_SENSORS))
        {
            ...
            final BaseTouchInput nextTouchInput) throws Exception
    {
        if (nextTouchInput != this.currentTouchInputFactory)
        {
            ...
            // this.logUtil.putF(this.currentTouchInputFactory, this, this.gameInputStrings.UDPATE_CURRENT_TOUCH_INPUT_FACTORY);
            PreLogUtil.put(this.currentTouchInputFactory.toString(), this, this.gameInputStrings.UDPATE_CURRENT_TOUCH_INPUT_FACTORY);

            this.touchButtonFactory.toggle(this.isPaused(),
    ...
    public void buildGame(final int portion) throws Exception
    {
        ...
        // this.logUtil.putF("Game Color Change", this, BUILD_GAME);
    ...
    public void shouldWait() throws Exception {
        ...
        if(AndroidUtil.isAndroid()) {
            ...
            if (features.isDefault(this.openGLFeatureFactory.OPENGL)) {
                ...
                //this.logUtil.putF("waiting for OpenGL to update:" + openGLImageSpecificFactory.updating, this, this.commonStrings.RUN);
                while (openGLImageSpecificFactory.updating) {
                    Thread.sleep(this.YIELD_SLEEP);
                    //this.logUtil.putF("waiting for OpenGL to update", this, this.commonStrings.RUN);
                }
            }
        }
    }
...
//        } else 
            ...
            /*
                ...
                while (this.isRunning())
                {
                    ...
                    synchronized (this)
                    {
                        // PreLogUtil.put("Wait", this, this.commonStrings.RUN);
                        this.threadObjectUtil.waitObject(this);
                        // PreLogUtil.put("Notified", this, this.commonStrings.RUN);
                    }
