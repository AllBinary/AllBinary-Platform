...
implements TickableInterface
{
    ...
    public void processTick(AllBinaryLayerManager allBinaryLayerManager) throws Exception
    {
        ...
        if (this.isExhausted() && !this.isDestroyed())
        {
            ...
            if (this.isReadyForExplosion())
            {
                ...
                {
                    //this.logUtil.putF("Explosion - End", this, tickableStrings.PROCESS_TICK);
            ...
            {       
                ...
                {
                    // this.logUtil.putF("Explosion - Begin", this, tickableStrings.PROCESS_TICK);
                ...
                {
                    // this.logUtil.putF("Explosion - Begin and End", this, tickableStrings.PROCESS_TICK);
    ...
    */
    ...
    public void damage(int damage, int damageType)
    {
        ...
        // this.logUtil.putF("Damage: " + damage +
    ...
    public int getDamage(int damageType)
    {
        if (!this.isExhausted())
        {
            ...
            // if(total > MAX)
            // this.logUtil.putF("Damage: " + total + " init: "
            // + this.getInitDamage() + " totalDamage: " + totalDamage, this, // "damage");
