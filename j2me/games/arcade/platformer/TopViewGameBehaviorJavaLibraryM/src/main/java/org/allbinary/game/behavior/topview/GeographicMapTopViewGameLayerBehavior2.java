    ...
    public void gravity(final VelocityProperties velocityProperties,
        ...
        if (geographicMapCellPosition != null) {
            ...
            if (!hasSolidBlock) {
                ...
                //this.logUtil.putF(new StringMaker().append("On Block: ").append(geographicMapCellPosition).append(" cellType: ").append(cellType).toString(), this, "gravity");
            }
        }
...
//            if(layer.getName().startsWith("BatEnemy")) {
//                this.logUtil.putF("Did not find impassable block ", this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
//            }
        }
    ...
    public GeographicMapCellPosition getGeographicMapCellPositionIfNotSolidBlockOrOffMap(final BasicGeographicMap[] geographicMapInterfaceArray, final GeographicMapCellType[] geographicMapCellTypeArray, final GeographicMapCellPosition geographicMapCellPosition, final VelocityProperties velocityProperties, final AllBinaryLayer layer) throws Exception {
        ...
        //this.logUtil.putF(geographicMapCellPosition.toString(), this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
...
//
            //this.logUtil.putF(possibleStepGeographicMapCellPosition.toString(), this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");

            final AllBinaryTiledLayer tiledLayer = geographicMapInterfaceArray[0].getAllBinaryTiledLayer();
            //this.logUtil.putF(new StringMaker().append("tileLayer: ").append(tiledLayer.getXP()).append(CommonSeps.getInstance().COLON).append(tiledLayer.getYP()).toString(), this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
            //this.logUtil.putF(new StringMaker().append("tileLayer: ").append(tiledLayer.getColumns()).append(CommonSeps.getInstance().COLON).append(tiledLayer.getRows()).toString(), this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
            ...
            //this.logUtil.putF("cellType: " + cellType, this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
             ...
             //|| basicPlatormGeographicMapCellTypeFactory.JUMP_THRU_CELL_TYPE.isType(cellType)
                if (hasSolidBlock || hasOffMap) {
                    ...
                    //this.logUtil.putF("found cellType: " + cellType, this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
...
//                        //this.logUtil.putF("Stepping at: y: " + newY, this, "getGeographicMapCellPositionIfNotSolidBlockOrOffMap");
...
//
//                //this.logUtil.putF(new StringMaker().append("Should Land at cellType: ").append(cellType).toString(), this, MOVE_AND_LAND);
...
//
//                    // this.logUtil.putF("Cell Position: y: " + geographicMapCellPosition.getPoint().getXP().intValue(), this, "moveAndLand");
//                    // this.logUtil.putF("Landing at: y: " + landY, this, "moveAndLand");
