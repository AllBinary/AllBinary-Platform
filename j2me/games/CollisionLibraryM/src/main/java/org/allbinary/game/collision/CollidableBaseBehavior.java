...
implements CollidableInterface
{
    ...
    public boolean isCollision(CollidableCompositeLayer collisionLayer)
    {
        ...
        {
            //this.logUtil.put("y: " + this.y + " " + this.getY2() + " other y: " + collisionLayer.getYP() + " " + collisionLayer.getY2(), this, damageUtil.IS_COLLISION);
            //this.logUtil.put("viewy: " + this.getViewPosition().getY() + " " + this.getViewPosition().getY2() + " other viewy: " + ((AllBinaryLayer) collisionLayer).getViewPosition().getY() + " " + ((AllBinaryLayer) collisionLayer).getViewPosition().getY2(), this, damageUtil.IS_COLLISION);
