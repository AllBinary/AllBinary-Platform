...
//            PreLogUtil.put(new StringMaker().append(myLayer.getName()).append(commonSeps.COLON).append(myLayer.getXP()).append(';').append(myLayer.getX2())
//                .append(',').append(myLayer.getYP()).append(';').append(myLayer.getY2()).append(',').append(myLayer.getZP()).append(';').append(myLayer.getZ2())
//                .append('?').append(myLayer2.getName()).append(commonSeps.COLON).append(myLayer2.getX()).append(';').append(myLayer2.getX2())
