...
public class TechRTSFormInput extends RTSFormInput
{
        ...
        throws Exception
    {
        ...
        this.logUtil.put(stringMaker.append("isUpgradeable: ").appendboolean(rtsInterface.isUpgradeable()).toString(), this, commonStrings.PROCESS);
        ...
        if (rtsInterface.isUpgradeable())
        {
            ...
            this.logUtil.put(stringMaker.appendint(cost).append("<=").appendint(capital.getTotalMoney()).toString(), this, commonStrings.PROCESS);
