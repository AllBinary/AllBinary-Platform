...
public class WaypointRunnableSelectedLogHelper extends WaypointRunnableLogHelper {
    ...
    public void start(final PathFindingLayerInterface pathFindingLayerInterface) {
        this.logUtil.putF(new StringMaker().append(pathFindingLayerInterface.getName()).append(commonStrings.START_RUNNABLE).toString(), this, commonStrings.RUN);
    }

    @Override
    public void end(final PathFindingLayerInterface pathFindingLayerInterface) {
        this.logUtil.putF(new StringMaker().append(pathFindingLayerInterface.getName()).append(commonStrings.END_RUNNABLE).toString(), this, commonStrings.RUN);
    }
