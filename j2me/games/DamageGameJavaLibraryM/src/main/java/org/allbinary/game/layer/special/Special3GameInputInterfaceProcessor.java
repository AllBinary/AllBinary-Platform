...
public class Special3GameInputInterfaceProcessor
extends SpecialGameInputInterfaceProcessor
{
    public Special3GameInputInterfaceProcessor(SpecialGameInputInterface collidableDestroyableDamageableLayer)
    {
