...
public class SpecialAnalogRightGameInputProcessor
extends SpecialGameInputProcessor
{
    public SpecialAnalogRightGameInputProcessor(CollidableDestroyableDamageableLayer collidableDestroyableDamageableLayer)
    {
