...
public class Special4GameInputInterfaceProcessor
extends SpecialGameInputInterfaceProcessor
{
    public Special4GameInputInterfaceProcessor(SpecialGameInputInterface collidableDestroyableDamageableLayer)
    {
