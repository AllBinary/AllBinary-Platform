...
public class SpecialUpGameInputInterfaceProcessor
extends SpecialGameInputInterfaceProcessor
{
    public SpecialUpGameInputInterfaceProcessor(SpecialGameInputInterface collidableDestroyableDamageableLayer)
    {
