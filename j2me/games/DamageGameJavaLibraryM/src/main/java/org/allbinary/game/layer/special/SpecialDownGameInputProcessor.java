...
public class SpecialDownGameInputProcessor
extends SpecialGameInputProcessor
{
    public SpecialDownGameInputProcessor(CollidableDestroyableDamageableLayer collidableDestroyableDamageableLayer)
    {
