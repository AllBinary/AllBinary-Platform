...
public class SpecialFireGameInputProcessor
extends SpecialGameInputProcessor
{
    public SpecialFireGameInputProcessor(CollidableDestroyableDamageableLayer collidableDestroyableDamageableLayer)
    {
