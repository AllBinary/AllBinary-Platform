...
public class SpecialLeftGameInputProcessor
extends SpecialGameInputProcessor
{
    public SpecialLeftGameInputProcessor(CollidableDestroyableDamageableLayer collidableDestroyableDamageableLayer)
    {
