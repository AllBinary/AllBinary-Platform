...
public class SpecialRightGameInputProcessor
extends SpecialGameInputProcessor
{
    public SpecialRightGameInputProcessor(CollidableDestroyableDamageableLayer collidableDestroyableDamageableLayer)
    {
