...
public class ResourceUtil
{
    ...
    */
    ...
    {
        this.logUtil.putF(new StringMaker().append("Resource Loader: ").append(resources.getClass().getName()).toString(), this, "setResources");
    ...
    public InputStream getResourceAsStream(final String resource) // , Object emulatorObject)
        throws Exception
    {   
        //this.logUtil.putF(new StringMaker().append(GETTING).append(resource).toString(), this, METHOD_NAME);
        ...
        if (inputStream != null)
        {
            //this.logUtil.putF(RESOURCE, this, METHOD_NAME);
