...
public class XmlRpcRemoteLogClient extends XmlRpcAbeClient
{
    ...
    public Object get(final Object object) throws Exception
    {
        try
        {
            ...
            //this.logUtil.putF("Client Info: \n" + hashtable.toString(), this, this.commonStrings.GET);
            // }
            ...
            //this.logUtil.putF("End Trying Server #" + this.getServer() + CommonLabels.getInstance().COLON_SEP + getClientInfo().getLicenseServer(this.getServer()), this, this.commonStrings.GET);
            // }
        ...
        } catch (IOException e)
        {
            ...
            //this.logUtil.putF("IOException Trying Other Servers", this, this.commonStrings.GET);
            // }
