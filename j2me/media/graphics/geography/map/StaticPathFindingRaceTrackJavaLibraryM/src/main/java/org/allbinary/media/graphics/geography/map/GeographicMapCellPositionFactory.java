...
public class GeographicMapCellPositionFactory extends GeographicMapCellPositionBaseFactory
{
  ...
  //For the Non Caching version - Turning off caching here requires turning of caching of paths as well
        ...
        throws Exception
    {
        ...
        {
            this.logUtil.putF(
                new StringMaker().append("Reusing GeographicMapCellPositionFactory for TileLayer: ").appendint(allBinaryTiledLayer.getDataId().intValue()).toString(), this, commonStrings.GET_INSTANCE);
