   ...
   extends RaceTrackDropCellPositionGenerator
{
            ...
            BaseRaceTrackGeographicMap raceTrackGeographicMap) throws Exception
    {
        ...
        AllBinaryTiledLayer tiledLayer = raceTrackGeographicMap.getAllBinaryTiledLayer();
            ...
            throws Exception
    {
        ...
        RaceTrackPickupLayer pickupLayer = (RaceTrackPickupLayer) 
            PickupLayerCircularStaticPool.getInstance().getInstance(pickedUpLayerInterfaceFactory, x, y);
