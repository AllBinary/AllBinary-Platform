    ...
    implements GetTextInterface
{
    ...
    public CustomTextAnimation(final String text, final int fontSize, final AnimationBehavior animationBehavior)
    {
        ...
        //this.logUtil.putF(new StringMaker().append("Font size: ").append(fontSize).append(CommonSeps.getInstance().SPACE).append(font.getSize()).append(commonLabels.WIDTH_LABEL).append(font.stringWidth(text)).append(" text: ").append(text).toString(), this, commonStrings.PROCESS);
...
//        if(font != null) {
//            final CommonLabels commonLabels = CommonLabels.getInstance();
//            this.logUtil.putF(new StringMaker().append("setText - font: ").append(font.getSize()).append(commonLabels.WIDTH_LABEL).append(font.stringWidth(text)).append(" text: ").append(text).toString(), this, commonStrings.PROCESS);
//        }
    }
