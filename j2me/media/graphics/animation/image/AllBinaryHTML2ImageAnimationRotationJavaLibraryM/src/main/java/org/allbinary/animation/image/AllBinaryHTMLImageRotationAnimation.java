...
extends ImageBaseRotationAnimation
{
    ...
    private final Canvas[] canvasSurfaceArray = new Canvas[2];
    ...
    public Canvas getCanvasSurface(final Image image) {
    ...
    private void updateImage() {
        final Canvas canvasSurface = this.canvasSurfaceArray[this.bufferedImageIndex];
        canvasSurface.save();
