...
public class ImageJ2MEScaleUtil {
    ...
    public Image[] scaleArray(final Image[] images, final int width, final int height)
            throws Exception
    {
    ...
    public Image scale(final Image image, final int width, final int height)
            throws Exception
    {        
        final Image scaledImage = ImageCopyUtil.getInstance().createImageWH(image, width, height, true);
