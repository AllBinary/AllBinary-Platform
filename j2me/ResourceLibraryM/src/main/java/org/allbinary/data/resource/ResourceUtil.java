...
//    }
    public void setClassLoader(final ClassLoader classLoader) {
        this.logUtil.putF(new StringMaker().append("Resource Loader: ").append(classLoader.getClass().getName()).toString(), this, "setClassLoader");
    ...
    private InputStream getResourceAsStreamAtStart(final String resource, final int startIndex)
        ...
        //this.logUtil.putF(stringMaker.append("Getting Resource: ").append(resourcePath).toString(), this, METHOD_NAME);
        //stringMaker.delete(0, stringMaker.length());
        //this.logUtil.putF(stringMaker.append("Start Index: ").append(startIndex).toString(), this, METHOD_NAME);
        ...
        if (inputStream != null) {
//            stringMaker.delete(0, stringMaker.length());
//            this.logUtil.putF(stringMaker.append(RESOURCE_FOUND).append(resourcePath).toString(), this, METHOD_NAME);
            return inputStream;
        }
        ...
        if (inputStream != null) {
//            stringMaker.delete(0, stringMaker.length());
//            this.logUtil.putF(stringMaker.append(RESOURCE_FOUND_WITH).append(resourcePath).append(commonSeps.COMMA).append(ResourceUtil.classLoader.getClass().getName()).toString(), this, METHOD_NAME);
        ...
        if (inputStream != null) {
//            stringMaker.delete(0, stringMaker.length());
//            this.logUtil.putF(stringMaker.append(RESOURCE_FOUND_WITH_CONTEXT_CLASS_LOADER).append(resourcePath).append(commonSeps.COMMA).append(Thread.currentThread().getContextClassLoader().getClass().getName()).toString(), this, METHOD_NAME);
            return inputStream;
        }
      ...
      if(inputStream != null)
      {
         this.logUtil.putF("Native Resource Found", this, METHOD_NAME);
      ...
      if(inputStream != null)
      {
         this.logUtil.putF("Resource Found In Specified Jar", this, METHOD_NAME);
      ...
      if(inputStream != null)
      {
         this.logUtil.putF("Resource Found In Jar", this, METHOD_NAME);
      ...
      if(inputStream != null)
      {
         this.logUtil.putF("Resource Found In File", this, METHOD_NAME);
      ...
      if(inputStream != null)
      {
         this.logUtil.putF("Resource Found In File - Absolute Path", this, METHOD_NAME);
      }
         */
        return inputStream;
    }
