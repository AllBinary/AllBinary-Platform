...
public class InputAutomationConfiguration
{
    ...
    public void add(
        ...
        throws Exception
    {
        this.logUtil.putF("Adding: " + inputAutomationModuleConfiguration.getName(), this, "add");
    ...
    public void remove(InputAutomationModuleFactoryInterface inputAutomationModuleInterface)
        throws Exception
    {
        this.logUtil.putF("Removing: " + inputAutomationModuleInterface.getName(), this, "remove");
        ...
        this.logUtil.putF("Number Of Module(s) Specified: " + nameNodeList.getLength(), this, "remove");
        ...
        for(int index = 0; index < nameNodeList.getLength(); index++)
        {
            ...
            if(nodeList!=null)
            {
                ...
                if(classNameNode!=null)
                {
                    ...
                    this.logUtil.putF("Name : " + className, this, "Contructor");
                ...
                {
                    this.logUtil.putF("Class Node Null", this, "Contructor");
                }
            }
            else
            {
                LogUtil.putF(InputAutomationData.NAME + " Name Node Node Children", this,"Contructor");
            }
        }
        this.save();
    }
