...
public class BasicAIProcessor
{
      ...
      throws Exception
   {
      ...
      //LogUtil.put(LogFactory.getInstance(this.getName() + " Off Path - Trying to get back on the path", this, "processAI"));
      ...
      {
      LogUtil.put(LogFactory.getInstance(this.getName() + " Off Path - for a while", this, "processAI"));
   ...
   {
   //LogUtil.put(LogFactory.getInstance(this.getName() + " currentGeographicMapCellPosition: " + currentGeographicMapCellPosition, this, "processAI"));
