...
public class TrueTypeFontUtilBase {
    ...
    public final String pattern = new String(this.patternAsBytes);
    ...
    protected final int[] _characterWidth = new int[this.pattern.length()]; //256
    protected final char[] characterArray = new char[1];
    protected final int size = this.pattern.length();
    protected final int lastCapIndex = this.pattern.indexOf('Z');
    ...
    public TrueTypeFontUtilBase(final int scale) {
        ...
        //this.logUtil.putF(Integer.toString(scale), this, this.commonStrings.CONSTRUCTOR);
...
//            .toString(), this, this.commonStrings.CONSTRUCTOR);
...
//        }
//        
//        this.logUtil.putF(stringMaker.toString(), this, this.commonStrings.CONSTRUCTOR);
    }
