...
public class ImagesRatioUtil
{
        ...
        throws Exception
    {
        ...
        this.logUtil.putF(
            ...
            " needed ratio: " + ((double) newWidth/newHeight), this, "fudge");
        ...
        if(point.x > 0)
        {
            ...
            this.logUtil.putF("Get the first column of the original of: " + bytes.length, this, "fudge");
        ...
        if(point.y > 0)
        {
            ...
            this.logUtil.putF("Get the first row of the original of: " + bytes.length, this, "fudge");
