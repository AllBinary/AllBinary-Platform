...
public class IncludeFileExtensionsBooleanFileVisitor extends BooleanFileVisitor
{
   public IncludeFileExtensionsBooleanFileVisitor(BasicArrayList filterStringBasicArrayList)
   {
