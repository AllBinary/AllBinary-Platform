    ...
    implements CategoryLoaderInterface
{
    ...
    public synchronized Document getDoc(CategoryInterface categoryInterface)
    {
        try
        {
                ...
                categoryInterface.getHierarchy()) != null)
            {
                ...
                {
                    AbFile rootAbFile = AbFile.createAbFileFromAbPath(categoryInterface.getRootFilePath());
   ...
   /*
    ...
    if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLLOGGING))
    {
    this.logUtil.put(this.commonStrings.FAILURE, this, "getUpToLevel", e);
    }
    return null;
    }
    }
    ...
    if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLLOGGING))
    {
    this.logUtil.put(this.commonStrings.FAILURE, this, "getAll", e);
    }
    return null;
    }
    }
