...
* 
*/
package org.allbinary.logic.basic.string.tokens;
...
public class Tokenizer
{
   ...
   {
       BasicArrayList tokenList = new BasicArrayList();
      int index = 0;
      ...
      while(index < size)
      {
         ...
         if(index != -1)
         {
            ...
            int end = string.indexOf(sep,index+1);            
            if(end != -1)
            {
               tokenList.add(string.substring(index+1,end));
