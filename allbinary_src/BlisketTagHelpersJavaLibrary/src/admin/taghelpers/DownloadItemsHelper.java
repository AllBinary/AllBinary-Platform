...
public class DownloadItemsHelper implements BasicTableInterface
{
	private final Portion portion;

   public DownloadItemsHelper(HashMap hashMap, PageContext pageContext)
   {
   ...
   public String create()
   {
      try
      {
         String success = DownloadItemsEntityFactory.getInstance().getDownloadItemsEntityInstance().createTable();
   ...
   public String  drop()
   {
      try
      {
         String success = DownloadItemsEntityFactory.getInstance().getDownloadItemsEntityInstance().dropTable();
   ...
   public String restore()
   {
      try
      {
         ...
         String result = DownloadItemsEntityFactory.getInstance().getDownloadItemsEntityInstance().restoreTable(this.portion);
         if(abcs.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(abcs.logic.communication.log.config.type.LogConfigType.SQLTAGS))
         {
   ...
   public String backup()
   {
      ...
      {
         String success = "Restore Successful";
         String result = DownloadItemsEntityFactory.getInstance().getDownloadItemsEntityInstance().backupTable();
         if(abcs.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(abcs.logic.communication.log.config.type.LogConfigType.SQLTAGS))
         {
