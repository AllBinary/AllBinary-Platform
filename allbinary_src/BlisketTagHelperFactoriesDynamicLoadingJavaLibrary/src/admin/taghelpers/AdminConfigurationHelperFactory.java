...
{
   private static final String CLASSNAME = "admin.taghelpers.AdminConfigurationHelper";
   private static final String FACTORYNAME = "AdminConfigurationHelperFactory";
   
   public AdminConfigurationHelperFactory()
   {
   }
