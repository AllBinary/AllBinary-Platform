...
{
   private static final String CLASSNAME = "admin.taghelpers.PermissionItemsRequestHelper";
   private static final String FACTORYNAME = "PermissionItemsRequestHelperFactory";
