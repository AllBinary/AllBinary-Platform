...
import allbinary.data.tables.user.commerce.inventory.item.special.SpecialItemsEntityFactory;

public class SpecialItemsHelper implements BasicTableInterface
{
   ...
   public String restore()
   {
      try
      {
         ...
         String result = SpecialItemsEntityFactory.getInstance().getSpecialItemsEntityInstance().restoreTable(this.portion);
         if(abcs.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(abcs.logic.communication.log.config.type.LogConfigType.SQLTAGS))
         {
   ...
   public String backup()
   {
      ...
      {
         String success = "Restore Successful";
         String result = SpecialItemsEntityFactory.getInstance().getSpecialItemsEntityInstance().backupTable();
         if(abcs.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(abcs.logic.communication.log.config.type.LogConfigType.SQLTAGS))
         {
