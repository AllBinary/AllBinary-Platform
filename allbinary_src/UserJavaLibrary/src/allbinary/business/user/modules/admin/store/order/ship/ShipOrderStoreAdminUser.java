...
* 
*/
package allbinary.business.user.modules.admin.store.order.ship;
...
public class ShipOrderStoreAdminUser extends User
{
   public ShipOrderStoreAdminUser() throws Exception
   {
      super();
   }

   public ShipOrderStoreAdminUser(HashMap userHashMap) throws Exception
   {
      super(userHashMap);
   }
