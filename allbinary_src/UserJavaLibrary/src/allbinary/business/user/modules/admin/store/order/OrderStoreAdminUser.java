...
* 
*/
package allbinary.business.user.modules.admin.store.order;
...
public class OrderStoreAdminUser extends User
{
   public OrderStoreAdminUser() throws Exception
   {
      super();
   }

   public OrderStoreAdminUser(HashMap userHashMap) throws Exception
   {
      super(userHashMap);
   }
