...
* 
*/
package allbinary.business.user.modules.customer.subscriber;
...
public class SubscriberUserFactory implements UserFactoryInterface
{
   public SubscriberUserFactory()
   {
   }
