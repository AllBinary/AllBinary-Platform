...
<form method="POST" action="<%= GROUPPRODUCTPAGE %>" enctype="multipart/form-data" >
<input class="text" type="hidden" name="<%= BasicItemData.NUMBER %>" size="11" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.WEIGHT %>" size="11" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.INBASKETS %>" size="11" value="0">
<input class="text" type="hidden" name="<%= BasicItemData.NEWORUSED %>" size="11" value="New">
<input class="text" type="hidden" name="<%= BasicItemData.CUSTOMS %>" size="50" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.DOWNLOADS %>" size="50" value="1" >
<input class="text" type="hidden" name="<%= BasicItemData.GROUPS %>" size="50" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.OPTIONS %>" size="50" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.PERMISSIONS %>" size="50" value="0" >
<input class="text" type="hidden" name="<%= BasicItemData.SPECIALS %>" size="50" value="0" >
