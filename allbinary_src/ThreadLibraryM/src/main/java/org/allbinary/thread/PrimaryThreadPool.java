...
public class PrimaryThreadPool extends ThreadPool
{
    ...
    {
        this.logUtil.put(new StringMaker().append(this.threadPoolStrings.START_TASK).append(StringUtil.getInstance().toString(task)).toString(), this, this.commonStrings.RUN);
    }

    @Override
    protected void completedTask(Runnable task)
    {
        this.logUtil.put(new StringMaker().append(this.threadPoolStrings.COMPLETE_TASK).append(StringUtil.getInstance().toString(task)).toString(), this, this.commonStrings.RUN);
    }
