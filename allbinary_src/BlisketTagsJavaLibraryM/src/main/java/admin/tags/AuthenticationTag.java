...
public class AuthenticationTag extends CustomTagSupport
{
    ...
    private boolean changePassword() throws LicensingException
    {
        ...
        } catch (Exception e)
        {
            ...
            {
                this.logUtil.putF(commonStrings.EXCEPTION, this, "changePassword()", e);
            }
            return false;
        }
    }
    ...
    private boolean newPassword() throws LicensingException
    {
        ...
        } catch (Exception e)
        {
            if (org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().JSPTAGERROR))
            {
                this.logUtil.putF(commonStrings.EXCEPTION, this, "newPassword()", e);
            }
            return false;
        }
    }
            ...
            if (command != null)
            {
                ...
                } else
                {
                    ...
                    if (this.isSessionOld())
                    {
                        //if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().JSPTAG))
                        //{
                        // this.logUtil.putF("Session is old",this,tagStrings.DO_START_TAG);
                        //}
                    ...
                    if (org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().JSPTAG))
                    {
                        this.logUtil.putF(new StringMaker().append("Major authentication error - userName: ").append(this.userName)
                            .append(" Password: ").append(this.password).append(" Command: ").append(this.command).toString(),
                            this, tagStrings.DO_START_TAG);
                    }
