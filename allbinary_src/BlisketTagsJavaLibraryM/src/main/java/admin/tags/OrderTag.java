...
public class OrderTag extends CustomTagSupport
{
   ...
   private Boolean setPaymentGateway() throws LicensingException
   {
      ...
      catch(Exception e)
      {
         ...
         if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLTAGSERROR))
         {
            this.logUtil.putF(commonStrings.EXCEPTION, this, "setPaymentGateway()", e);
         }
   ...
   private String getMaxAmount() throws LicensingException
   {
      ...
      catch(Exception e)
      {
         ...
         if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLTAGSERROR))
         {
            this.logUtil.putF(commonStrings.EXCEPTION,this,"getMaxAmount()",e);
         }
         return "Unknown";
      }
   }
   */
   ...
   private String getOrderIdFromSession() throws LicensingException
   {
      ...
      catch(Exception e)
      {
         ...
         if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLTAGSERROR))
         {
            this.logUtil.putF(commonStrings.EXCEPTION,this,"getOrderIdFromSession()",e);
         }
         return "Unknown";
      }
   }   
