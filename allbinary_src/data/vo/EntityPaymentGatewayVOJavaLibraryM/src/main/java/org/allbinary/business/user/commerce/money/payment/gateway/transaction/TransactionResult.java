...
public class TransactionResult implements TransactionResultInterface
{
   ...
   public BasicArrayList getValues()
   {
      BasicArrayList keyVector = this.getAllPossibleKeys();
      BasicArrayList valueVector = new BasicArrayListD();
