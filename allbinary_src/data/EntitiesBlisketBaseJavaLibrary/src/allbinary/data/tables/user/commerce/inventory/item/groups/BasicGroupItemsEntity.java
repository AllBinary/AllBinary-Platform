...
import allbinary.business.user.commerce.inventory.item.group.BasicGroupItemData;
...
*/
   ...
   BasicGroupItemData.ITEM_ONE + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_TWO + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_THREE + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_FOUR + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_FIVE + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_SIX + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_SEVEN + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_EIGHT + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_NINE + " VARCHAR(255) NOT NULL," +
   BasicGroupItemData.ITEM_TEN + " VARCHAR(255) NOT NULL," +
