...
{
   //private static final String CLASSNAME = "allbinary.data.tables.user.commerce.money.payment.gateway.PaymentGatewayEntity";
   ...
   public static PaymentGatewayEntityInterface getInstance() throws Exception
   {
      try
      {
         ...
         return (PaymentGatewayEntityInterface) new allbinary.data.tables.user.commerce.money.payment.gateway.PaymentGatewayEntity();
      }
      /*
