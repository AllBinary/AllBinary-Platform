...
public class TransactionEntity extends AbSqlBean implements TransactionEntityInterface
{
    ...
    /*
     ...
     if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLLOGGING))
     {
     this.logUtil.putF(this.commonStrings.SUCCESS,this,"getTransactionInterface()");
     }
     ...
     if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().SQLLOGGING))
     {
     this.logUtil.putF(this.commonStrings.FAILURE,this,"getTransactionResultInterface()",e);
     }
     return null;
     }
     }
