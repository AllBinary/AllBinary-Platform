...
//role username or other //who has permission                
        stringBuffer.append(PermissionItemData.WHO)
                .append(this.sqlTypeStrings.MAX_CHAR_COLUMN_NOT_NULL)
                .append(PermissionItemData.WHAT)
                .append(this.sqlTypeStrings.MAX_CHAR_COLUMN_NOT_NULL)
                .append(PermissionItemData.TYPE)
                .append(this.sqlTypeStrings.MAX_CHAR_COLUMN_NOT_NULL)
                .append(PermissionItemData.REMOTE_ADDR)
                .append(this.sqlTypeStrings.MAX_CHAR_COLUMN_NOT_NULL)
                .append(PermissionItemData.START_TIME)
                .append(this.sqlTypeStrings.MAX_BIG_INT_UNSIGNED_NOT_NULL)
                .append(PermissionItemData.END_TIME)
                .append(this.sqlTypeStrings.MAX_BIG_INT_UNSIGNED_NOT_NULL)
                .append(BasicItemData.PRICE)
                .append(" DECIMAL (11,2) NOT NULL,")
