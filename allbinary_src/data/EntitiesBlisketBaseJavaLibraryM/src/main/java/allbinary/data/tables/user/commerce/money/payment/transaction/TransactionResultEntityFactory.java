...
public class TransactionResultEntityFactory
{
   ...
   //private final String CLASSNAME = "allbinary.data.tables.transaction.TransactionResultEntity";
   ...
   public TransactionResultEntity getTransactionResultEntityInstance() //throws LicensingException
   {
      try
      {
         ...
         return new allbinary.data.tables.user.commerce.money.payment.transaction.TransactionResultEntity();
      }
      /*
