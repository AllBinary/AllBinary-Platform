...
* 
*/
package allbinary.data.tables.user.commerce.inventory.item.permissions;
...
{   
   protected final String tableName = "permissionitems";   
   ...
   //role username or other //who has permission
   PermissionItemData.WHO + " VARCHAR(255) NOT NULL," +   
   
   PermissionItemData.WHAT + " VARCHAR(255) NOT NULL," +
   
   PermissionItemData.TYPE + " VARCHAR(255) NOT NULL," +   
   
   PermissionItemData.REMOTE_ADDR + " VARCHAR(255) NOT NULL," +
   
   PermissionItemData.START_TIME + " BIGINT(19) UNSIGNED NOT NULL, " + 
   PermissionItemData.END_TIME + " BIGINT(19) UNSIGNED NOT NULL, " + 
