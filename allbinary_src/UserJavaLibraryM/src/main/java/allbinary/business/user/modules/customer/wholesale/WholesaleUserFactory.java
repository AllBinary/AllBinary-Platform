...
* 
*/
package allbinary.business.user.modules.customer.wholesale;
...
public class WholesaleUserFactory implements UserFactoryInterface
{
   public WholesaleUserFactory()
   {
   }
