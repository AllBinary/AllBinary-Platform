...
* 
*/
package allbinary.business.user.modules.admin.store.customer;
...
public class CustomerStoreAdminUser extends User
{
   public CustomerStoreAdminUser() throws Exception
   {
      super();
   }

   public CustomerStoreAdminUser(HashMap userHashMap) throws Exception
   {
      super(userHashMap);
   }
