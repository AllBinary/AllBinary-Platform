...
* 
*/
package allbinary.business.user.modules.admin.store.payment;
...
public class PaymentStoreAdminUser extends User
{
   public PaymentStoreAdminUser() throws Exception
   {
      super();
   }

   public PaymentStoreAdminUser(HashMap userHashMap) throws Exception
   {
      super(userHashMap);
   }
