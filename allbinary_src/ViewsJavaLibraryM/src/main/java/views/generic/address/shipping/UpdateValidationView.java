...
public class UpdateValidationView extends ShippingAddressView implements ValidationComponentInterface
{   
   public UpdateValidationView(TransformInfoInterface transformInfoInterface) throws Exception
   {
