...
public class InventorySearch implements InventoryViewSearchInterface
{
    ...
    public String searchSingleStaticPage() throws Exception
    {
        ...
        catch (Exception e)
        {
            ...
            {
                LogUtil.put(LogFactory.getInstance(this.sqlStrings.COMMAND_FAILED, this, "searchSingleStaticPage", e));
            }
    ...
    public String searchSingleDynamicPage() throws Exception
    {
        ...
        catch (Exception e)
        {
            ...
            {
                LogUtil.put(LogFactory.getInstance(this.sqlStrings.COMMAND_FAILED, this, "searchSingleDynamicPage", e));
            }
