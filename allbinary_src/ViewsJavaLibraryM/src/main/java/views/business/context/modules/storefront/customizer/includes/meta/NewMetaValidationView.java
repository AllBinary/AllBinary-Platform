...
public class NewMetaValidationView extends MetaView implements ValidationComponentInterface
{
    protected final LogUtil logUtil = LogUtil.getInstance();

   public NewMetaValidationView(TransformInfoInterface transformInfoInterface) throws Exception
   {
