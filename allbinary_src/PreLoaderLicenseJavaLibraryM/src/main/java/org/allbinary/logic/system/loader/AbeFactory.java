   ...
   public synchronized static Object getNoLicenseInstance(String className, Class classes[], Object params[]) throws LicensingException
   {
      ...
      catch (Exception e)
      {
         if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().LOADERERROR))
         {
        	 ...
        	 this.logUtil.put(stringBuffer.toString(), this, "getNoLicenseInstance(String className, Class classes[], Object params[])", e);
         }
         return null;
      }
   }
         ...
         /*public synchronized static Object getInstance(String className)
   {
      try
      {
         ...
         /*
            ...
            {
               this.logUtil.putF("Getting Instance", this, this.commonStrings.GET_INSTANCE);
            }
          */
...
/*
            if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().LOADER))
            {
               if(loader==null)
               {
                  this.logUtil.putF("Loader Null", this, this.commonStrings.GET_INSTANCE);
               }
               else
               {
                  this.logUtil.putF("Loader Not Null", this, this.commonStrings.GET_INSTANCE);
               }
            }
 */
  ...
  /*
            if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().LOADER))
            {
               if(c==null)
               {
                  this.logUtil.putF("Class Null", this, this.commonStrings.GET_INSTANCE);
               }
               else
               {
                  //this.logUtil.putF("isInstance: " + myClass.isInstance(), this, this.commonStrings.GET_INSTANCE);
                  this.logUtil.putF("Class Not Null", this, this.commonStrings.GET_INSTANCE);
               }
            }
   */
   //         return c.newInstance();
...
/*      }
   ...
   public synchronized static Object getDefaultInstance(String className, Class classes[], Object params[])
   {
      ...
      catch (Exception e)
      {
         if(org.allbinary.logic.communication.log.config.type.LogConfigTypes.LOGGING.contains(org.allbinary.logic.communication.log.config.type.LogConfigTypeFactory.getInstance().LOADERERROR))
         {
            this.logUtil.put("Failure for: " + className + " " + allbinary.java.object.ObjectInfo.viewConstructor(constructor, CommonSeps.getInstance().NEW_LINE), this,"getInstance(className,params)", e);
         }
         return null;
      }
   }
