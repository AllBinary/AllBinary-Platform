...
<%
/*
Inserting template customizer views
 */

   customizerSet = 
      viewNameKeyAndTemplateCustomizerStoreHashMap.keySet();
   ...
   while(customizerIter.hasNext())
   {
      ...
      String nextTemplateFile = (String) 
         viewNameKeyAndTemplateCustomizerStoreHashMap.get(nextPage);
      ...
      String nextPreClassPath = (String)
         viewNameKeyAndCustomizerStoreClassPathsPreHashMap.get(nextPage);
      String nextPostClassPath = (String)
         viewNameKeyAndCustomizerStoreClassPathsPostHashMap.get(nextPage);
%>
...
//objectFile="%= STOREFRONTCONTEXTCLASSPATH + "customizer." + nextClassPath + "." + nextViewPrefix + nextPage + "ValidationView" %"
   ...
   (String) viewNameKeyAndCustomizerStoreObjectConfigsHashMap.get(nextPage);
