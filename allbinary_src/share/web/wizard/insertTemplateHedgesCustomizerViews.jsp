...
<%
/*
Inserting template customizer views for hedge views
 */

   customizerSet = 
      viewNameKeyAndTemplateCustomizerHedgesHashMap.keySet();
   ...
   while(customizerIter.hasNext())
   {
      ...
      String nextTemplateFile = (String) 
         viewNameKeyAndTemplateCustomizerHedgesHashMap.get(nextPage);
      //String nextObjectConfigFile = (String) 
      //   viewNameKeyAndCustomizerHedgeObjectConfigsHashMap.get(nextPage);
      String nextPreClassPath = (String)
         viewNameKeyAndCustomizerHedgesClassPathsPreHashMap.get(nextPage);
      String nextPostClassPath = (String)
         viewNameKeyAndCustomizerHedgesClassPathsPostHashMap.get(nextPage);
%>
...
//objectFile="%= STOREFRONTCONTEXTCLASSPATH + "customizer." + nextClassPath + "." + nextViewPrefix + nextPage + "ValidationView" %"
   ...
   (String) viewNameKeyAndCustomizerHedgeObjectConfigsHashMap.get(nextPage);
