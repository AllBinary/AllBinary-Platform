...
-->            
         ...
         <xsl:variable name="numberOfBillingAddresses" select="STREETADDRESS_NUMBEROFADDRESSES/value" />
...
<xsl:call-template name="submitMenuButtonItem">
   <xsl:with-param name="name">
      <xsl:value-of select="$SELECTBILLINGADDRESS" />
   </xsl:with-param>
...
<xsl:call-template name="submitMenuButtonItem">
   <xsl:with-param name="name">
      <xsl:value-of select="$REMOVEBILLINGADDRESS" />
   </xsl:with-param>
   <xsl:with-param name="command">
      <xsl:value-of select="$REMOVEBILLINGADDRESS" />
   </xsl:with-param>
...
<xsl:call-template name="submitMenuButtonItem">
   <xsl:with-param name="name">
      <xsl:value-of select="$MAKENEWBILLINGADDRESS" />
   </xsl:with-param>
   <xsl:with-param name="command">
      <xsl:value-of select="$MAKENEWBILLINGADDRESS" />
   </xsl:with-param>
