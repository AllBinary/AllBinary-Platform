...
>
   ...
   <xsl:template match="/html" >
      ...
      <xsl:variable name="SETBILLINGADDRESSTOSHIPPINGADDRESS" select="SETBILLINGADDRESSTOSHIPPINGADDRESS/value" />
      
      <xsl:variable name="numberOfBillingAddresses" select="BILLINGADDRESSES/STREETADDRESS_NUMBEROFADDRESSES" />
...
<br></br><xsl:value-of select="$addressName" />
...
-->
      <xsl:for-each select="BILLINGADDRESS" >
      
      <xsl:variable name="numberOfBillingAddresses" select="NUMBEROFADDRESSES/value" />
      
         <xsl:if test="$numberOfBillingAddresses=0" >   
...
<xsl:call-template name="submitMenuButtonItem">
   <xsl:with-param name="name">
      <xsl:value-of select="$SETBILLINGADDRESSTOSHIPPINGADDRESS" />
   </xsl:with-param>
   <xsl:with-param name="command">
      <xsl:value-of select="$SETBILLINGADDRESSTOSHIPPINGADDRESS" />      
   </xsl:with-param>
