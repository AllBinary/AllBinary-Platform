...
>
   ...
   <xsl:template match="/html" >
      ...
      <xsl:variable name="CHANGEPAYMENTNAME" select="CHANGEPAYMENT/name" />
      <xsl:variable name="CHANGEPAYMENT" select="CHANGEPAYMENT/value" />
...
<xsl:call-template name="submitMenuButtonItem">
   <xsl:with-param name="name">
      <xsl:value-of select="$CHANGEPAYMENT" />
   </xsl:with-param>
   <xsl:with-param name="command">
      <xsl:value-of select="$CHANGEPAYMENTNAME" />
   </xsl:with-param>
</xsl:call-template>
