...
<!--
Verisign Order Basket
-->
   <xsl:template name="orderVerisignBasketSummaryView" >
...
Shipping Address
-->
   <xsl:template name="orderVerisignBillingAddressView" >
      <xsl:for-each select="/html" >
         <xsl:for-each select="en" >
            <xsl:for-each select="US" >
...
-->   
 <xsl:template name="orderVerisignShippingAddressView" >
      <xsl:for-each select="/html" >
         <xsl:for-each select="en" >
            <xsl:for-each select="US" >
...
-->   
   <xsl:template name="orderVerisignShippingSummaryView" >
      <xsl:for-each select="/html" >
         <xsl:for-each select="en" >
            <xsl:for-each select="US" >
               <xsl:for-each select="Verisign_Payflow_Pro/ORDERHISTORY" >
...
<xsl:value-of select="$total" />
   ...
   <xsl:template name="orderVerisignView" >
