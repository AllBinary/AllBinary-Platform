...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="userInputForm" >
...
<table class="table" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="500">
  ...
  <tr>
    <td width="51%">User Role:</td>
    <td width="49%">
       <select class="text" size="1" name="{$roleName}" >
          <option value="{$roleValue}" ><xsl:value-of select="$roleValue" /></option>
       </select>
    </td>
  </tr>
  <tr>
