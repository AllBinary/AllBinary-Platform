...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="mouseMenuItemPreview"
      ...
      <jutil:element name="div">
         ...
         <jutil:attribute name="onClick">
            abScrollTo('menuItemMouseOut<xsl:value-of select="$scrollName" />');<xsl:value-of select="$javascriptErrorControl" />
         </jutil:attribute>
   ...
   <xsl:template name="mouseBodyItemPreview"
      ...
      <jutil:element name="div">
         ...
         <jutil:attribute name="onClick">
            abScrollTo('bodyItemMouseOut<xsl:value-of select="$scrollName" />');<xsl:value-of select="$javascriptErrorControl" />
         </jutil:attribute>
   ...
   <xsl:template name="mouseButtonMenuItemPreview"
    ...
    <xsl:template name="mouseButtonBodyItemPreview"
      ...
      <jutil:element name="div">
         ...
         <jutil:attribute name="onClick">
            abScrollTo('bodyButtonItemMouseOut<xsl:value-of select="$scrollName" />');<xsl:value-of select="$javascriptErrorControl" />
         </jutil:attribute>
