...
<generic:shippingaddress command="%= command %" storeName="%= STORENAME %" 
   xsl="%= IGNOREXMLXSL %" >

   <ecommerce:shippingaddress isSelected="true" command="%= command %" >
      <jsp:forward page="%= paymentGatewayPageData.BILLINGADDRESS %" />
   </ecommerce:shippingaddress>

      <jsp:forward page="%= paymentGatewayPageData.SHIPPINGADDRESS %" />
