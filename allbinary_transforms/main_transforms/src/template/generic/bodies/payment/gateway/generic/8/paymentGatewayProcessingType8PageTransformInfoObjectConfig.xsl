...
<OBJECTCONFIG_NAME OBJECTCONFIG_NAME="Payment Gateway Processing" >
   ...
   <TRANSFORM_COMPONENTS_NAME TRANSFORM_COMPONENTS_GROUP="TRANSFORM_COMPONENTS_ALL" >
      ...
      <COMPONENT_NAME TRANSFORM_INFO_NAME="$STOREFRONT_NAME {$PAYMENTGATEWAY_NAME} Authorize" >
      </COMPONENT_NAME>
      <COMPONENT_NAME TRANSFORM_INFO_NAME="$STOREFRONT_NAME {$PAYMENTGATEWAY_NAME} BillingAddress" >
      </COMPONENT_NAME>
      <COMPONENT_NAME TRANSFORM_INFO_NAME="$STOREFRONT_NAME {$PAYMENTGATEWAY_NAME} Checkout" >
      </COMPONENT_NAME>
      <COMPONENT_NAME TRANSFORM_INFO_NAME="$STOREFRONT_NAME {$PAYMENTGATEWAY_NAME} Payment" >
      </COMPONENT_NAME>
